        ...
        <div> 
                ...
                {list.map((item)=>{
                        return(
                            ...
                            <td class="table-success">{item.quantity}</td>
                                ...
                                <td class="table-success"><button type="button" class="btn btn-danger" name="cartid" value={item.cartid} onClick={handleRemove}>Remove</button></td>   
            ...
            <table class="table table-success table-hover table-striped">
                ...
                {confirmedlist.map((item)=>{
                    ...
                    <tr><td colSpan={3}>Total To Pay</td><td>₹{totalPay}</td><td><button  type="button" class="btn btn-primary" onClick={handlePayment}>Pay Now</button></td></tr>
                </tbody>
