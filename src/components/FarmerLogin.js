...
// });
    ...
    var onSubmit = (e)=>{
        ...
        {
          setCaptchErrMsg("Please check captcha box");
        }   
    }
    const [captchaErrMsg,setCaptchErrMsg] = useState("")
                        ...
                        <div className="col-md-4 offset-md-4 " >
                            <div className="login-form bg-light mt-4 p-4 " style={{borderRadius : "30px"}} >
                                <form onSubmit={onSubmit} className="row g-3" >
                                    ...
                                    <ReCAPTCHA
                                      sitekey="6LfgxXofAAAAAGoFohQzlGUnoyZh4dLDcZnJy-Sz"
                                      onChange={handleCaptcha}
                                    />
                                   <p className="text-danger">{captchaErrMsg}</p> 
                                   </div>
